        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div
                        class="text-center p-6 border-2 border-dashed border-primary/30 rounded-lg hover:border-primary/50 transition-colors">
                ...
                @if (!Route::is('aboutus'))
                    <Button variant="default" size="lg"
                        class="bg-primary p-2 rounded-md text-white hover:bg-white border border-primary hover:text-primary transition ease-in duration-200">
