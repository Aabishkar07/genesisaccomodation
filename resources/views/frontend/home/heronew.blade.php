<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10  px-4 sm:px-6 lg:px-8 text-center text-white">
        <div class="max-w-5xl mx-auto">
            ...
            <div
                class="bg-white/98 backdrop-blur-sm rounded-2xl p-4 mb-8 shadow-xl max-w-5xl mx-auto border border-gray-200/50">
                    ...
                    <div class="flex-1 min-w-0">
                        <div
                            ...
                            <select
                                ...
                                <option value="shared" class="text-gray-800 bg-white py-2 px-3 hover:bg-gray-50">🏠
                                    Shared Room</option>
                                <option value="private" class="text-gray-800 bg-white py-2 hover:bg-gray-50">🚪 Private
                                    Room</option>
                                <option value="studio" class="text-gray-800 bg-white py-2 hover:bg-gray-50">🏢 Studio
                                </option>
                                <option value="apartment" class="text-gray-800 bg-white py-2 hover:bg-gray-50">🏠
                                    Apartment</option>
                            </select>
                    ...
                    <div class="flex-1 min-w-0">
                        <div
                            ...
                            <select
                                ...
                                <option value="0-500" class="text-gray-800 bg-white py-2 hover:bg-gray-50">💰 $0 - $500
                                </option>
                                <option value="500-1000" class="text-gray-800 bg-white py-2 hover:bg-gray-50">💰 $500 -
                                    $1,000</option>
                                <option value="1000-1500" class="text-gray-800 bg-white py-2 hover:bg-gray-50">💰 $1,000
                                    - $1,500</option>
                                <option value="1500-2000" class="text-gray-800 bg-white py-2 hover:bg-gray-50">💰 $1,500
                                    - $2,000</option>
                                <option value="2000+" class="text-gray-800 bg-white py-2 hover:bg-gray-50">💎 $2,000+
                                </option>
                            </select>
                            <svg class="absolute right-2 h-3 w-3 text-gray-400 pointer-events-none" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 min-w-0">
                        <div
                            ...
                            <select
                                ...
                                <option value="1" class="  text-gray-800 bg-white py-2 hover:bg-gray-50">👤 1 Guest
                                </option>
                                <option value="2" class="text-gray-800 bg-white py-2 hover:bg-gray-50">👥 2 Guests
                                </option>
                                <option value="3" class="text-gray-800 bg-white py-2 hover:bg-gray-50">👥 3 Guests
                                </option>
                                <option value="4" class="text-gray-800 bg-white py-2 hover:bg-gray-50">👥 4+ Guests
                                </option>
                            </select>
                            <svg class="absolute right-2 h-3 w-3 text-gray-400 pointer-events-none" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
