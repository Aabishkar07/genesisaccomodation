<div class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition duration-300 p-6 border border-gray-100">
    <img src="{{ asset('uploads/' . $service->image) }}" alt="Room Service"
        class="w-full h-48 object-contain rounded-lg mb-6">
