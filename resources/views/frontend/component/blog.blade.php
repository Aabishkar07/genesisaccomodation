<article class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
    ...
    <div class="p-6">
        ...
        <!-- Title -->
        <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-primary transition-colors duration-300 line-clamp-2 leading-tight">
        ...
        <div class="flex items-center justify-between pt-4 border-t border-gray-100">
            ...
            <!-- Share Button -->
            <button onclick="navigator.share({title: '{{ $blog->title }}', url: '{{ route('single', $blog->slug) }}'})"
