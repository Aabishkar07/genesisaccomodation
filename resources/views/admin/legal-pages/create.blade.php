...
@section('page-title', 'Create Legal Page')

@section('content')
    <div class="bg-white rounded-lg shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Create New Legal Page</h3>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required
                            ...
                            <option value="terms_conditions" {{ old('type') === 'terms_conditions' ? 'selected' : '' }}>Terms & Conditions</option>
                        </select>
                        @error('type')
