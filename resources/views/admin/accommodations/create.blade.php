    ...
    <form action="{{ route('admin.accommodations.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Accommodation Name *</label>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                            @php
                                $commonAmenities = [
                                    ...
                                    'Free Parking', 'Pool', 'Gym', 'Spa', 'Restaurant', 'Bar', 'Room Service',
                                    'Concierge', 'Security', 'Elevator', 'Balcony', 'Garden', 'Terrace',
                                    'BBQ Facilities', 'Bicycle Rental', 'Car Rental', 'Airport Shuttle'
                                ];
                            @endphp
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                        <label for="gallery" class="block text-sm font-medium text-gray-700 mb-2">Upload Gallery Images</label>
