            ...
            @if ($aboutUs)
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        @if (
                            $aboutUs->og_title ||
                                $aboutUs->og_description ||
                                $aboutUs->og_image ||
                                $aboutUs->twitter_title ||
                                $aboutUs->twitter_description ||
                                $aboutUs->twitter_image)
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                @if ($aboutUs->og_image)
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $aboutUs->og_image) }}" alt="OG Image"
                                ...
                                @if ($aboutUs->twitter_image)
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $aboutUs->twitter_image) }}"
