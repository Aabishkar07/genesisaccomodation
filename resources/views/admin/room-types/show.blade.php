                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $roomType->status == 'available' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="text-sm text-gray-900">{{ $roomType->created_at->format('F j, Y \a\t g:i A') }}
                                </p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Updated At</label>
                                <p class="text-sm text-gray-900">{{ $roomType->updated_at->format('F j, Y \a\t g:i A') }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        @if ($roomType->featured_image)
                            <div class="mb-4">
                                <img src="{{ asset('uploads/' . $roomType->featured_image) }}" alt="{{ $roomType->name }}"
                        ...
                        <div class="space-y-4">
                            ...
                            @if ($roomType->meta_image)
                                <div>
                                    ...
                                    <img src="{{ asset('uploads/' . $roomType->meta_image) }}" alt="Meta Image"
                                        class="w-full h-24 object-cover rounded-lg">
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            @if ($roomType->og_image)
                                <div>
                                    ...
                                    <img src="{{ asset('uploads/' . $roomType->og_image) }}" alt="OG Image"
                                        class="w-full h-24 object-cover rounded-lg">
                                </div>
                            @endif
