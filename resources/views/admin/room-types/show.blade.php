    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('admin.room_types.edit', $roomType) }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                    Edit
                </a>
                <a href="{{ route('admin.room_types.index') }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                    Back to List
                </a>
            </div>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    @if($roomType->featured_image)
                        <div class="mb-4">
                            <img src="{{ asset('uploads/' . $roomType->featured_image) }}" alt="{{ $roomType->name }}" class="w-full h-48 object-cover rounded-lg">
                        </div>
                    @else
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        @foreach($roomType->gallery as $image)
                            <img src="{{ asset('uploads/' . $image) }}" alt="Gallery Image" class="w-full h-24 object-cover rounded-lg">
                        @endforeach
                    </div>
                </div>
                @endif
                    ...
                    <div class="space-y-4">
                        ...
                        @if($roomType->meta_image)
                            <div>
                                ...
                                <img src="{{ asset('uploads/' . $roomType->meta_image) }}" alt="Meta Image" class="w-full h-24 object-cover rounded-lg">
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        @if($roomType->og_image)
                            <div>
                                ...
                                <img src="{{ asset('uploads/' . $roomType->og_image) }}" alt="OG Image" class="w-full h-24 object-cover rounded-lg">
                            </div>
                        @endif
