                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="8" required
                            class="w-full px-3 tinymce py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="icon" class="block text-sm font-medium text-gray-700 mb-2">Icon Link : <a
                                target="_blank" class="text-blue-500" href="https://tablericons.com/">Click here to choose
                                icon </a> </label>
