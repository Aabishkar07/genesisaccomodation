                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <div class="mt-1 text-sm text-gray-900">{{ $service->created_at->format('M d, Y H:i') }}
                                </div>
                            </div>

                            <div>
                                <span class="text-xs font-medium text-gray-500 uppercase">Updated</span>
                                <div class="mt-1 text-sm text-gray-900">{{ $service->updated_at->format('M d, Y H:i') }}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-3">
                                ...
                                @if ($service->og_image)
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $service->og_image) }}" alt="OG Image"
                                ...
                                @if ($service->twitter_image)
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $service->twitter_image) }}"
