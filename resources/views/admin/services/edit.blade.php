            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $service->title) }}"
                            required
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="8" required
                            class="w-full px-3 py-2 tinymce border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description', $service->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="icon" class="block text-sm font-medium text-gray-700 mb-2">Icon Link : <a
                                class="text-blue-500" href="https://tablericons.com/">Click here to choose icon </a>
                        </label>
                        ...
                        @if ($service->image)
                            <div class="mb-4">
                                <img src="{{ asset('uploads/' . $service->image) }}" alt="{{ $service->name }}"
                                    class="w-full oldimage h-32 object-cover rounded-lg">
                            </div>
                        @endif
                        <img id="output" style="width: 100px; margin-bottom: 2px;margin-top: 10px;" />

                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Upload New
                                Image</label>
                        ...
                        <div class="space-y-4">
                            ...
                            @if ($service->meta_image)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset('uploads/' . $service->meta_image) }}" alt="Meta Image"
                                        class="w-full h-24 object-cover rounded-lg oldimage2">
                                </div>
                            @endif
                            <img id="output2" style="width: 100px; margin-bottom: 2px;margin-top: 10px;" />
