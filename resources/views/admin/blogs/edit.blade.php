                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="12" required
                            class="w-full px-3 tinymce py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('content', $blog->content) }}</textarea>
                        @error('content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        @if ($blog->featured_image)
                            <div class="mb-4">
                                <img src="{{ asset('uploads/' . $blog->featured_image) }}" alt="{{ $blog->title }}"
                                    class="w-full h-32 object-contain rounded-lg oldimage">
                            </div>
                        @endif
                        ...
                        <div class="space-y-4">
                            ...
                            @if ($blog->meta_image)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset('uploads/' . $blog->meta_image) }}" alt="Meta Image"
                            ...
                            <div>
                                <label for="meta_image" class="block text-sm font-medium text-gray-700 mb-2">Upload New
                                    Meta Image</label>
                                <input type="file" name="meta_image" id="meta_image" onchange="loadFile2(event)"
                                    accept="image/*"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                @error('meta_image')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
