                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="12" required
                            class="w-full px-3 tinymce py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('content') }}</textarea>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div>
                            ...
                            <input type="file" name="featured_image" id="featured_image" onchange="loadFile(event)"
                                accept="image/*"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <img id="output" style="width: 70px; margin-bottom: 2px;margin-top: 10px;" />
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="file" name="meta_image" id="meta_image" accept="image/*" onchange="loadFile2(event)"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                    <img id="output2" style="width: 70px; margin-bottom: 2px;margin-top: 10px;" />
                                @error('meta_image')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="og_image" class="block text-sm font-medium text-gray-700 mb-2">Open Graph
                                    Image</label>
                                <input type="file" name="og_image" id="og_image" accept="image/*" onchange="loadFile3(event)"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                    <img id="output3" style="width: 70px; margin-bottom: 2px;margin-top: 10px;" />
                                @error('og_image')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="twitter_image" class="block text-sm font-medium text-gray-700 mb-2">Twitter
                                    Image</label>
