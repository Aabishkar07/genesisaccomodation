            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <div class="flex items-center space-x-3">
                        ...
                        <form method="POST" action="{{ route('admin.blogs.toggle-display-all') }}" class="inline">
                            @csrf
                            @method('PUT')
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ route('admin.blogs.destroy', $blog) }}" method="POST"
                                        class="delete-form-{{ $blog->id }} inline">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                No blogs found. <a href="{{ route('admin.blogs.create') }}"
                                    class="text-blue-600 hover:text-blue-900">Create your first blog</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
