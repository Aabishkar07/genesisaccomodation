...
<div class="bg-white rounded-lg shadow-sm">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-medium text-gray-900">Create Testimonial</h3>
    </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="testimonial" id="testimonial" rows="6" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('testimonial') }}</textarea>
                    @error('testimonial')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="meta_image" class="block text-sm font-medium text-gray-700 mb-2">Upload Meta Image</label>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="og_image" class="block text-sm font-medium text-gray-700 mb-2">Upload OG Image</label>
                        ...
                        <div>
                            <label for="twitter_image" class="block text-sm font-medium text-gray-700 mb-2">Upload Twitter Image</label>
